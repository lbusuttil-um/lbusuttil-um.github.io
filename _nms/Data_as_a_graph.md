...
ConceptualAdvantage: "Semi structured data can be visualized as a graph or a tree"
DrawsAttentionTo: "flexible representation of data
data model that is quick in sharing of documents among systems and databases"
...
Mapping:
  nodes :  objects
  arcs :  labels (like attribute names)
---
### Alternate Versions
