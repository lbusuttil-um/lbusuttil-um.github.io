...
ConceptualAdvantage: "Shows the process of converting to 2NF via example"
DrawsAttentionTo: "Functional dependencies and the steps required to transform to 2NF"
