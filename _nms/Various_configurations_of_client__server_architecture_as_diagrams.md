---
title: "Various configurations of client / server architecture as diagrams"
author: "xiaoying-tu"
Discipline: Databases
ConceptualAdvantage: "Visualizes various examples of client / server architecture configurations"
DrawsAttentionTo: "Several possibilities of client / server archiecture configurations in the context of database systems: whether client and server processes are on the same machine, one vs. many clients / servers, etc."
...
image: "352.png"
Mapping:
  computer icon :  end user
  rectangles :  client / server processes
  cylinders :  storage / database
  cloud :  network
---
### Alternate Versions
