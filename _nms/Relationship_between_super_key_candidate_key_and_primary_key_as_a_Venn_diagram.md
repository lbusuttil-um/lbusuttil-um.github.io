---
title: "Relationship between super key, candidate key, and primary key as a Venn diagram"
author: "xiaoying-tu"
Discipline: Databases
ConceptualAdvantage: "Helps clarify the relationship between the 3 \"key\" concepts: CK is a subset of SK (a minimal one); PK is a subset of CK (the one we pick)."
DrawsAttentionTo: "The relationship between SK, CK, and PK."
